 ...
 */
class  NoteSelectKBComponent  : public Component,
...
public:
    ...
    /** Creates a NoteSelectKBComponent.
     ...
     */
    NoteSelectKBComponent (MidiKeyboardState& state,
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (NoteSelectKBComponent)
};
