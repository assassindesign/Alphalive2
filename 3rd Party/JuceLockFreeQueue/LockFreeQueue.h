 ...
 * EDIT:
 * This class need to be suitable for access by the audio thread
 * and has been modified to use a circular buffer instead of
 * calling delete on every produce.
 */
template<typename T>
class LockFreeQueue
{
